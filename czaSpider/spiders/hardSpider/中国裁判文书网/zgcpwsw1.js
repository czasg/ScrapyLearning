var anti_first = function(argv1, argv2){
    var wzwsquestion=argv1;
    var wzwsfactor=argv2;
    //此处为加密后的数组(顺序加密)
...
var _0x213d = function(_0xe8191e, _0x5b709c) {
    ...
    var _0x32912a = __0x31a2a[_0xe8191e];//DsOBXcORFsKt
    ...
    var _0x253d5a = _0x213d['data'][_0xe8191e]; //undefined
    ...
    if (_0x253d5a === undefined) {
        if (_0x213d['once'] === undefined) {
            ...
            _0xe2055f['prototype']['checkState'] = function() {
                ...
                return this['runState'](_0x3d707c['test'](this['newState']['toString']()) ? --this['states'][0x0] : --this['states'][0x1]); // 没法执行toString，这里走错误的流程
            };
