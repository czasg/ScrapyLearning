...
2016.06.17 - 博客编辑页面，root管理博客页面，个人管理个人博客页面
2016.06.17 - 对scrapy的理解还是不深，很多都不会
2016.06.17 - 工作所需：scrapy基本原理、反爬知识（涉及js重定向，加密，投毒等）、爬虫selenium模块、后端aiohttp、flask、Django模块，前端js，Vue模块，简单的异步实现
2016.06.17 - 工作经历：
