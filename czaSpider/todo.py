...
"""
# todo, 分布式爬虫scrapy-redis原理起码要研究研究
# todo，爬虫，IP代理需要部署好，为自己提供服务，今晚回去可以研究研究   https://blog.csdn.net/chengqiuming/article/details/86794318   的写法。redis自带打分的玩意嘛
# todo，监控机制，被动监控
# todo，个人网站上面，把简历说法再整理整理
