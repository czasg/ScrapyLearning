...
2019.01.12 - 介绍resume.html页面（写一写历史线就差不多了=0=）
2019.01.12 - 爬虫的数据分析结果，可以将分析结果返回，传到前段，这个怎么搞
2019.01.12 - 前段炸裂特效，，这个需要从长计议啊，怎么展示是个问题
2019.07.12 - 如何关注前沿知识，什么是持续跟进一个项目？？？？
"""

"""DONE!
2019.01.12 - （首先新的爬虫可以开始看看了，以先看职位，如boss直招和智联招聘这两个，房天下爬虫也可以看看，那么爬虫就有4个了）
2019.01.12 - 3个新爬虫（boss直招、智联招聘、房天下，共计四个在线爬虫）。
2019.01.12 - 今天再把搜索功能移植过去，基本已有的就都OK了，然后就是添加新的功能。
