...
function secondHtml() {
    let e = "";
    for (let t = 0; t < 60; t++)
        e += "<li><span>" + NumberToChinese(t) + "</span></li>";
    $(".second ul").html(e);
    for (let e = 0; e < 60; e++) {
        if ($(".second ul li").eq(e).css("transform", "rotate(" + 6 * e + "deg)"),
        30 != e) {
...
function minuteHtml() {
    ...
    $(".minute ul").html(e);
    for (let e = 0; e < 60; e++) {
        if ($(".minute ul li").eq(e).css("transform", "rotate(" + 6 * e + "deg)"),
        30 != e) {
...
function hourHtml() {
    let e = "";
    for (let t = 0; t < 12; t++)
        e += "<li><span>" + NumberToChinese(t) + "时</span></li>";
    $(".hour ul").html(e);
    for (let e = 0; e < 12; e++) {
        if ($(".hour ul li").eq(e).css("transform", "rotate(" + 30 * e + "deg)"),
        6 != e) {
